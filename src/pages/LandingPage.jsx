      ...
      <div className="main-content-wrapper">
        ...
        <div className="center-content">
          ...
          <p className="landing-disclaimer">
            Disclaimer: This site uses publicly available data from ClinicalTrials.gov. We are not affiliated with or endorsed by ClinicalTrials.gov or the U.S. National Institutes of Health. Data was last processed on <strong>06/10/2025</strong>.
          </p>
        </div>
